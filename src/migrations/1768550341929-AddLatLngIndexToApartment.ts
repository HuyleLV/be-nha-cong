...
export class AddLatLngIndexToApartment1768550341929 implements MigrationInterface {
    name = 'AddLatLngIndexToApartment1768550341929'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`IDX_9ea1ef9b641bfe2e52d40d1ad4\` ON \`apartments\` (\`lat\`, \`lng\`)`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_9ea1ef9b641bfe2e52d40d1ad4\` ON \`apartments\``);
